...
int main(){
    ...
    fShader MyShader("../src/Transformation/File/vshader.s", "../src/Transformation/File/fshader.s");
    ...
    char* name[] = {
        "../src/Transformation/File/container.jpg",
        "../src/Transformation/File/awesomeface.png"
    };
    unsigned char* data;
