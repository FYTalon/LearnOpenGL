...
int main(){
    ...
    fShader LightingShader("../src/Materials/File/vshader.s", "../src/Materials/File/fshader.s");
    fShader LampShader("../src/Materials/File/lvshader.s", "../src/Materials/File/lshader.s");
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        LightingShader.use();
        LightingShader.setVec3("light.ambient", lightColor * glm::vec3(0.5f));
        LightingShader.setVec3("light.diffuse", lightColor * glm::vec3(0.01f));
