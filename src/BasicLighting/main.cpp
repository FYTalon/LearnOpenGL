...
int main(){
    ...
    fShader LightingShader("../src/BasicLighting/File/vshader.s", "../src/BasicLighting/File/fshader.s");
    fShader LampShader("../src/BasicLighting/File/lvshader.s", "../src/BasicLighting/File/lshader.s");
